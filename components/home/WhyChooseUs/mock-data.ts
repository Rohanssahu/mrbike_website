...
import {
  DigitalServiceHistoryIcon,
  DoorstepConvenienceIcon,
  LiveTrackingIcon,
  ServiceWarrantyIcon,
  TransparentPricingIcon,
  VerifiedMechanicsIcon,
...
export const WHY_CHOOSE_US_FEATURES: FeatureRecord[] = [
  ...
  },
  {
    ...
    icon: DigitalServiceHistoryIcon,
